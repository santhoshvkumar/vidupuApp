...
class ProfileMaster{
    ...
    public function changePassword() {
        ...
        try
        {
            ...
            $queryUpdatePassword = "UPDATE tblEmployee SET employeePassword = ? , deviceFingerprint = '' WHERE employeeID = ?";
    ...
    public function forgotPassword() {
        ...
        try {
            ...
            if ($rs = mysqli_fetch_assoc($result)) {
                ...
                $queryUpdatePassword = "UPDATE tblEmployee SET employeePassword = ?, deviceFingerprint = '' WHERE employeePhone = ?";
                $updateStmt = mysqli_prepare($connect_var, $queryUpdatePassword);
